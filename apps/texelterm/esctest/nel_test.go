...
//
// This file contains tests for the NEL (Next Line) escape sequence.
//
// Original esctest2 source:
//   - Project: https://github.com/ThomasDickey/esctest2
//   - File: esctest/tests/nel.py
...
// Test_NEL_Basic tests that NEL moves the cursor down one line and to column 1.
func Test_NEL_Basic(t *testing.T) {
	d := NewDriver(80, 24)
...
// Test_NEL_Scrolls tests that NEL scrolls when it hits the bottom.
func Test_NEL_Scrolls(t *testing.T) {
	d := NewDriver(80, 24)
...
// Test_NEL_ScrollsInTopBottomRegionStartingAbove tests that NEL scrolls when it hits
// the bottom region (starting above top).
func Test_NEL_ScrollsInTopBottomRegionStartingAbove(t *testing.T) {
	d := NewDriver(80, 24)
...
// Test_NEL_ScrollsInTopBottomRegionStartingWithin tests that NEL scrolls when it hits
// the bottom region (starting within region).
func Test_NEL_ScrollsInTopBottomRegionStartingWithin(t *testing.T) {
	d := NewDriver(80, 24)
...
// Test_NEL_MovesDoesNotScrollOutsideLeftRight tests that cursor moves down but won't scroll
// when outside left-right region.
func Test_NEL_MovesDoesNotScrollOutsideLeftRight(t *testing.T) {
	d := NewDriver(80, 24)
...
// Test_NEL_StopsAtBottomLineWhenBegunBelowScrollRegion tests that when the cursor starts below
// the scroll region, NEL moves it down to the bottom of the screen but won't scroll.
func Test_NEL_StopsAtBottomLineWhenBegunBelowScrollRegion(t *testing.T) {
	d := NewDriver(80, 24)
