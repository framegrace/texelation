...
Apps and cards can trigger effects via the control bus when appropriate (e.g.,
diagnostics toggles, workspace overlays) without reaching into card internals.
