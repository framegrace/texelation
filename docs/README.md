...
It has a tiling panel manager, multiple desktops, desktop effects and its own go app format to be extended.
On the plans: 
...
All this code has been generated by multiple AI's. Please check the note at the end.
