...
//
// File: texel/effects.go
// Summary: Implements effects capabilities for the core desktop engine.
// Usage: Used throughout the project to implement effects inside the desktop and panes.
