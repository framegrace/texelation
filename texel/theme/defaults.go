...
func ApplyDefaults(cfg Config) {
	...
	if applySectionDefaults(cfg, "texelterm", Section{
		// Enable long-line overlay editor by default for wide-shell UX
		"longline_overlay_enabled": true,
		// More visible overlay for long command line editor
		"longline_overlay_bg": "#383a46",
		"longline_overlay_fg": "#f8f8f2",
	}) {
		changed = true
	}
